http % 3A % 2F % 2Flocalhost % 3A9000 % 2F % 23 % 2F "use strict";
angular.module("pomasanaAppApp", ["ngRoute", "ngCookies", "ngResource", "ngSanitize", "LocalStorageModule", "angular-loading-bar", "mgcrea.ngStrap", "ui.bootstrap", "progressButton", "angularSpinner"]).value("baseUrl", "http://pomasana.appspot.com/api").value("redirectBaseUrl", "http%3A%2F%2Flocalhost%3A9000%2F%23%2F").config(["$routeProvider",
    function(a) {
    ...
    return {
        ...
        link: function(a, b, c) {
            a.$parent[c.progressButton] = a, a.progressStart = function() {
                var c = b,
                    d = (new Date).getTime();
                if (!b.hasClass("in-progress")) {
                    c.on("progress", function() {
                        d = (new Date).getTime()
                    });
                    var e = window.setInterval(function() {
                        (new Date).getTime() > 2e3 + d && a.progressIncrement(.05)
                    }, 500);
    ...
    function(a, b, c, d, e, f, g) {
        a.projects = {}, a.tasks = {}, a.selectedProject = {}, a.loading = !1, a.loadProjects = function() {
            a.loading = !0, c.query(function(b) {
                a.projects = b.data.data, a.selectedProject = a.projects[0], a.loadTasks()
            }, function(b) {
                a.loading = !1, d.handle(b)
            })
        }, a.loadTasks = function() {
            a.loading = !0, a.task = {}, c.getTasks({
                id: a.selectedProject.id
            }, function(b) {
                a.loading = !1, a.tasks = b.data
            }, function(b) {
                a.loading = !1, d.handle(b)
            })
        }, a.load = function() {
    ...
    function(a, b, c, d, e, f, g, h, i) {
        a.pomotasks = {}, a.loading = !1, a.loadPomotasks = function() {
            a.loading = !0, "/pomotasks-todo" === b.path() && a.loadTodoPomotasks(), "/pomotasks-done" === b.path() && a.loadDonePomotasks()
        }, a.rate = 1, a.loadTodoPomotasks = function() {
            g.getPomoTasks({
                completed: "false"
            }, function(b) {
                a.loading = !1, a.pomotasks = b.data
            }, function(b) {
                a.loading = !1, e.handle(b)
            })
    ...
    function(a, b, c, d, e, f, g) {
        a.pomotask = e, a.data = {
            ...
            d.FB.ui({
                ...
                b.close(), g.pomodoroShared()
            })
        }, a.ok = function(b) {
            b.progressStart(), c.createPomodoro(a.data, function() {
                b.progressFinish(), a.added = !0, d.setTimeout(function() {
                    g.pomodoroAdded()
                }, 1e3)
            }, function(a) {
                b.progressFinish(), f.handle(a)
            })
        }, a.cancel = function() {
            b.dismiss("cancel")
        }, a.close = function() {
    ...
    function(a, b, c, d, e, f, g, h, i) {
        ...
        var j;
        a.pomotask = e, a.finished = !1, a.running = !1;
        var k = function() {
            j = new Worker("timerWorker.js"), j.addEventListener("message", function(b) {
                a.currentTime = b.data, 0 === a.currentTime.bigTime && a.running && (a.finished = !0, a.running = !1, i.pomodoroFinished()), a.$apply()
            }, !1)
        };
        a.startTimer = function() {
            k(), a.running = !0, j.postMessage({
                cmd: "start"
            })
